*&---------------------------------------------------------------------*
*& Report ZT_211_EDU_3WEEK_TEST_10_LOOP
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT ZT_211_EDU_3WEEK_TEST_010_LOOP.
...
DATA gt_line2 LIKE LINE OF gt_itab2.

LOOP AT gt_itab INTO gt_line2.
  INSERT gt_line2 INTO TABLE gt_itab2. "인터널 테이블에 넣을 때는 INTO TABLE 필수
ENDLOOP.
